	...
	<div class="content">
		<div class="order">
			...
			<div class="order_right_content">
				<div class="headline"><h1>查看产品信息</h1></div>
				<table frame="border" cellpadding="0" cellspacing="0" width="90%">
				  <caption><h2>产品信息</h2></caption>
				  <tr>
				    <td>产品名</td>
				    <td>描述</td>
				    <td>图片</td>
				  ...
				  <c:forEach var="product" items="${list}">
				    <tr>
				      ...
				      <td><a href="${pageContext.request.contextPath }/images/${product.image }">查看图片</a></td>
				      <td>
				        <a href="#">修改</a>
				        <a href="${pageContext.request.contextPath }/manager/ProductServlet?method=delete&id=${product.id}">删除</a>
				      </td>
				    </tr>
				  </c:forEach>
				</table>
