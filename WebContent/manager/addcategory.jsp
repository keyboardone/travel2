	...
	<div class="content">
		<div class="order">
			...
			<div class="order_right_content">
				<div class="headline"><h1>添加分类信息</h1></div>
				<form action="${pageContext.request.contextPath}/manager/CategoryServlet?method=add" method="post">
				<ul>
					<li>分类名称:<span><input type="text" name="name" style="width: 200px"></span></li>
					<li>分类描述:<span><textarea rows="4" cols="40" name="description"></textarea></span></li>
					<li><input type="submit" value="添加分类"></li>
				</ul>
				</form>
