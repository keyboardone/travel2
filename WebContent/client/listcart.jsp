	...
	<div class="content">
		...
		<div class="order_left">
			...
			<div class="order_left_f">
				...
				<ul>
					...
					<li><a href="${pageContext.request.contextPath }/client/listcart.jsp" style="background:#A0E1D9;color: white;border-radius: 3px;">我的购物车</a></li>
				</ul>
		...
		<div class="order_right">
			<div class="order_right_content">
				...
				<div class="sum">
					商品合计：￥<span>${cart.price }元</span><br>
					<a href="${pageContext.request.contextPath }/client/OrderServlet?id=${user.id}"><input type="button" value="提交订单"/></a>
				</div>
			</div>
		</div>
		</div>
